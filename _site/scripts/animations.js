...
const animateHero = heroTL.to(heroCube, {
    duration: 8,
    rotationX: 360,
    rotationY: 720,
    ease: 'none',
...
const animateStar = starTL.to(star, {
    duration: .5,
    rotation: 45,
    scale: 3,
    ease: 'none',
...
const animateFallingParagraphs = function () {
    return (
...
const animateProjectsAppearing = function () {
    return (
        document.addEventListener("DOMContentLoaded", function () {
            if ('IntersectionObserver' in window) {
